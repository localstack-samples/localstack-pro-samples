...
public class ProducerRegisteringNewSchema {
    ...
    public static void main(String[] args) {
        ProducerRegisteringNewSchema producer = new ProducerRegisteringNewSchema();
    ...
    public UnicornRideRequest getRecord(int requestId) {
        ...
        UnicornRideRequest rideRequest = UnicornRideRequest.newBuilder()
                ...
                .setRecommendedUnicorn(RecommendedUnicorn.newBuilder()
                        ...
                        .setStarsRating(5).build()).build();
                // we removed the (previously required) customer data here in the new version of the producer
