# Lambda Remote Debugging (JavaScript)
...
6. Set a breakpoint in `hello-world/app.mjs`.
...
2. Set a breakpoint in `hello-world/app.mjs`.
3. Open the **Run and Debug** view and run the **JavaScript: Remote Attach** task.
